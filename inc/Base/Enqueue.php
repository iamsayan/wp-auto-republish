    ...
    public function admin_assets()
    {
        ...
        if ( strpos( $current_screen->base, 'wp-auto-republish' ) !== false ) {
            ...
            wp_localize_script( 'wpar-admin-js', 'wpar_admin_i10n', [
                ...
                'save_cron_success' => __( 'Settings Saved & Cron Rescheduled Successfully!', 'wp-auto-republish' ),
                'delete_success'    => __( 'All post data & logs deleted successfully!', 'wp-auto-republish' ),
                'delete_confirm'    => __( 'It will delete all the data relating to single post republishing and logs. Do you want to continue?', 'wp-auto-republish' ),
